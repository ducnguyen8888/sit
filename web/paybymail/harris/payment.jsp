...
--%><%@ page import="java.util.*,act.util.AppConfiguration,act.sit.*" 
%><%
    ...
    AppConfiguration    configuration       = new AppConfiguration(pageContext, "sitGalveston");
        ...
        <div style="width:960px;margin:0 auto;">
            <div style="display:inline-block;width:50%;">
                <div style="display:inline-block;height:100%;vertical-align:middle;padding-top:20px;font-size:20px;font-weight: bold; padding-left:5px;color:darkblue;">
                    Special Inventory Tax<br><div style="font-size:14px;font-style:italic;">Payments by Mail</div>
                </div>
            </div>
    ...
    <script>
        app.run( function($rootScope, $location, $log, $injector, errorManager, HeartbeatService, $interval, $http, $timeout) {
            ...
            $rootScope.application = {
                            ...
                            showAprdistacc: <%= sitAccount.SHOW_CAD_NO_IN_SIT_PORTAL %>
                            };
            ...
            $rootScope.config = {
                            load: true,
                            urls: { configuration: "control/configuration.jsp" }
                            };
            ...
            $rootScope.$on('configuration loaded', function(event,configuration) {
                ...
                $log.warn("Process Page: " + $rootScope.pages.PROCESS );
                $log.warn("Success Page: " + $rootScope.pages.SUCCESS );
            });
...
app.config(['$routeProvider','$locationProvider',
    function($routeProvider,$locationProvider) {
        ...
        $routeProvider
                ...
                .when('/Mail', {
                    templateUrl: 'app/checkout/vendor/mail/success/MailKickoffFrame.html?'+Date.now(),
                    controller: 'MailKickoffController'
                })
                ;
}]);
