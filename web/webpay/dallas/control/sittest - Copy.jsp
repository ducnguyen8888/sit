...
%><%
    ...
    try {
        ...
        %><div class="content"><%= getObjectInformation(conn,objectName) %></div><%
...
--%><%!
public class getObjectSummary implements Runnable {
    public getObjectSummary(Connection conn, String objectName) {
