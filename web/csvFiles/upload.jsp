...
<div class="container" role="main">
	...
	<nav role="navigation">
		<a href="" class="is-selected">Auto Submit</a>
		<a href="">Submit On Demand</a>
	</nav>
	...
	;( function( $, window, document, undefined )
	{
		...
		$( '.box' ).each( function()
		{
			...
			$input.on( 'change', function( e )
			{
				...
				//$form.trigger( 'submit' );
                console.log("Submit on file select triggered");
			});
			...
			if( isAdvancedUpload )
			{
				...
				.on( 'drop', function( e )
				{
                    ...
                    console.log("Submit on drop triggered");
				});
			}
	...
	;( function ( document, window, index )
	{
		...
		Array.prototype.forEach.call( forms, function( form )
		{
			...
			input.addEventListener( 'change', function( e )
			{
				...
				console.log("Input change event - would have triggered upload");
			});
			...
			if( isAdvancedUpload )
			{
				...
				form.addEventListener( 'drop', function( e )
				{
					...
					//triggerFormSubmit();
                    console.log("drop event - would have triggered upload");
			...
			{
                console.log("Form event listener submit triggered");
                return;
				// preventing the duplicate submissions if the current one is in progress
