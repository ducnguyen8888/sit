        ...
        try (
             PreparedStatement ps  = conn.prepareStatement(
                     "with "
                             ...
                             + "           and UPPER(dealerships.can) like nvl( UPPER(?), UPPER(dealerships.can)  )"
                             + "           and UPPER(owner.nameline1) like nvl ( UPPER(?), UPPER(owner.nameline1) )"
                             + "           and UPPER(owner.nameline2) || ' ' || UPPER(owner.nameline3) || ' ' || UPPER(owner.nameline4) like nvl( UPPER(?), UPPER(owner.nameline2) || ' ' || UPPER(owner.nameline3) || ' ' || UPPER(owner.nameline4) )"
                             + "           and UPPER(dealerships.userid) like nvl ( UPPER(?),UPPER(dealerships.userid) ) "
                             + "           and UPPER(dealerships.username) like nvl( UPPER(?), UPPER(dealerships.username) )"
                             + " order by "
